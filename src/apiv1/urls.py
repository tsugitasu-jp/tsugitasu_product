...
from apiv1.material_views import MaterialCreateAPIView, HistoryTreeGetAPIView, GetMaterialAPIView, GetLatestMaterialsAPIView
...
urlpatterns = [
    ...
    path('content/<str:cid>/b<int:bid>/v<int:ver>/',
         GetMaterialAPIView.as_view()),
